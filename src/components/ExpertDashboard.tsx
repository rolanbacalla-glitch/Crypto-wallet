...
export function ExpertDashboard() {
  ...
  const itemVariants = {
    ...
    show: { 
      ...
      transition: {
        duration: 0.4,
        ease: [0.25, 0.1, 0.25, 1.0] // Power ease
      }
    }
  };
  ...
  return (
    <motion.div 
      ...
      initial="hidden"
      animate="show"
      className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 md:p-8 pt-4 pb-12 font-mono"
    >
      
      {/* Top Protocol Status Bar */}
      <motion.div 
        variants={itemVariants} 
        className="col-span-1 md:col-span-12 grid grid-cols-2 lg:grid-cols-4 gap-4 mb-2"
      >
        {[
