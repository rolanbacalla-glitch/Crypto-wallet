...
export function BeginnerDashboard() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 p-4 md:p-8 pt-4 pb-12">
      
      {/* Safety Hero - Central Piece */}
      <GlassCard className="col-span-1 md:col-span-12 lg:col-span-8 flex flex-col md:flex-row items-center gap-8 py-10 px-8 bg-gradient-to-br from-lime-500/10 to-transparent border-lime-500/20" glow persona="normal">
      ...
      {/* Quick Access Tiles */}
      <GlassCard className="col-span-1 md:col-span-6 lg:col-span-4 flex flex-col justify-between border-white/5">
      ...
      <GlassCard className="col-span-1 md:col-span-6 lg:col-span-7">
      ...
      <GlassCard className="col-span-1 md:col-span-12 lg:col-span-5">
